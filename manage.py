...
import os
import sys
from qed_django.temp_config.set_environment import DeployEnv
# from temp_config.set_environment import DeployEnv


# this needs to be added so that the stting in the subdirectory django app can be found
root_path = os.path.join(os.path.abspath(os.path.split(__file__)[0]), 'qed_django')
...
if __name__ == "__main__":
	...
	if os.environ.get('DJANGO_SETTINGS_FILE'):
		os.environ.setdefault("DJANGO_SETTINGS_MODULE", os.path.join("qed_django", os.environ.get('DJANGO_SETTINGS_FILE')))
	else:
		os.environ.setdefault("DJANGO_SETTINGS_MODULE", "qed_django/settings_kube")
